...
public class LevelEND extends GameState {
    ...
    public void init() {
        ...
        mountains = new Background("/Backgrounds/3lvl.gif", 0.2);

        // TILE
        tileMap = new TileMap(90);
        tileMap.loadTiles("/Tilesets/3lvl.gif");
        tileMap.loadMap("/Maps/LevelEND.map");
        ...
        teleport.setPosition(3300,750 );
/*
        // teleport FOR TEST
        teleport = new Teleport(tileMap);
        teleport.setPosition(180, 800);
*/
        // START SLUCHAYA
        eventStart = true;
    ...
    private void populateEnemies() {
        ...
        enemies.add(gp);
        gp = new Jija(tileMap, player);
        gp.setPosition(2680, 100);
        gp = new Jija(tileMap, player);
        gp.setPosition(1700, 100);
        enemies.add(gp);
        gp = new Jija(tileMap, player);
        gp.setPosition(3177, 100);
        enemies.add(gp);
        gp = new Jija(tileMap, player);
        gp.setPosition(1960, 100);
        enemies.add(gp);
        gp = new Jija(tileMap, player);
        gp.setPosition(2580, 100);
        enemies.add(gp);
        gp = new Jija(tileMap, player);
        gp.setPosition(3000, 100);
        enemies.add(gp);
        g = new Ghost(tileMap);
        g.setPosition(3000, 750);
        enemies.add(g);
        g = new Ghost(tileMap);
        g.setPosition(2960, 750);
        enemies.add(g);
        g = new Ghost(tileMap);
        g.setPosition(2170, 750);
        enemies.add(g);
        g = new Ghost(tileMap);
        g.setPosition(2400, 750);
        enemies.add(g);
        g = new Ghost(tileMap);
        g.setPosition(2600, 750);
        enemies.add(g);
        g = new Ghost(tileMap);
        g.setPosition(2500, 750);
        enemies.add(g);
    }
...
////////////////////////////// SLUCHAI
    ...
    private void eventFinish() {
        ...
        if(eventCount == 180) {
            ...
            gsm.setState(GameStateManager.GAMEOVERSCREEN);
        }
